...
test_image_path= r"./debug"

os.makedirs(test_image_path, exist_ok=True)

for d in ["origin0", "origin_b_image", "dilated_image"]:
    os.makedirs(os.path.join(test_image_path, d), exist_ok=True)
...
# fragment image path
data_path = r"D:\jigsaw\china2\different_n_pieces\35 circle_sample_V5_2\fragments"
sub_list = os.listdir(data_path)
'''get GT transformation'''
global matching_set

# save path
root = r'D:\jigsaw\china2\different_n_pieces\35 circle_sample_V5_2\ori_dataset_all.pkl'
count = []
